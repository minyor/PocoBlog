...
function populateStates( countryElementId, stateElementId, defaultState ){
	...
	//	stateElement.options[0] = new Option(defaultState,'');
	//else
	...
	stateElement.selectedIndex = state_arr.indexOf(defaultState) + 1;
}
...
function populateCountries(countryElementId, stateElementId, defaultCountry, defaultState){
	...
	//	countryElement.options[0] = new Option(defaultCountry,'-1');
	//else
	...
	countryElement.selectedIndex = country_arr.indexOf(defaultCountry) + 1;
