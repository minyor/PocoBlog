...
#line 4 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
...
#line 6 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
SESSION	std::ostream& responseStream = response.send();
	...
	responseStream << "\n";
	responseStream << "\t";
#line 8 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\t";
#line 9 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\t";
#line 10 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\t";
#line 11 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t";
#line 13 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
TILE_BEGIN("content")	responseStream << "\n";
	responseStream << "\t\t";
#line 14 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
IF(me["mode"] == "activated")	responseStream << "\n";
	responseStream << "\t\t\t<h1>Activation Successful!</h1>\n";
	responseStream << "\t\t\tThe account for ";
#line 16 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
	responseStream << (me.newUser->username());
	responseStream << " has been successfully activated!\n";
	responseStream << "\t\t";
#line 17 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
...
#line 19 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
	...
	responseStream << "\t\t";
#line 21 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
ELIF(!user)	responseStream << "\n";
	responseStream << "\t\t\t<h1>Registration:</h1>\n";
	responseStream << "\t\t\t";
#line 23 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
	responseStream << (me.captcha.htmlUse());
	responseStream << "\n";
	responseStream << "\t\t\t<form method=\"POST\" action=\"*signin\" id=\"userForm\">";
#line 24 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
	responseStream << (CSRF);
	responseStream << "\n";
	responseStream << "\t\t\t\t<div class=\"userCol1\">Username:</div><div class=\"userCol2\"><input type=\"text\" ";
#line 25 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
	responseStream << (NAME(username));
	responseStream << "></div>\n";
	responseStream << "\t\t\t\t<div class=\"userCol1\">Email Address:</div><div class=\"userCol2\"><input type=\"text\" ";
#line 26 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
	responseStream << (NAME(email));
	responseStream << "></div>\n";
	responseStream << "\t\t\t\t<div class=\"userCol1\">Password:</div><div class=\"userCol2\"><input type=\"password\" ";
#line 27 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
	responseStream << (NAME(password));
	responseStream << "></div>\n";
	responseStream << "\t\t\t\t<div class=\"userCol1\">Confirm Password:</div><div class=\"userCol2\"><input type=\"password\" ";
#line 28 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
	responseStream << (NAME(password2));
	responseStream << "></div>\n";
	responseStream << "\t\t\t\t<div class=\"userCol1\">";
#line 29 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
...
#line 31 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
	responseStream << (me["status"]);
	responseStream << "</span></div>\n";
	responseStream << "\t\t\t</form><!--Forgot your password?-->\n";
	responseStream << "\t\t";
#line 33 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
ELSE	responseStream << "\n";
	responseStream << "\t\t\t<h1>You are already registered.</h1>\n";
	responseStream << "\t\t";
#line 35 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
ENDIF	responseStream << "\n";
	responseStream << "\t";
#line 36 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
TILE_END	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t";
#line 38 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\t";
#line 39 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t";
#line 41 "/media/DATA_1/_/Data/Core/Developing/WebServer/src/view/Registration.c"
