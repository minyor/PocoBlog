...
#line 4 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
...
#line 6 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
SESSION	std::ostream& responseStream = response.send();
	...
	responseStream << "\n";
	responseStream << "\t";
#line 8 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
TILE_BEGIN("head")	responseStream << "\n";
	...
	responseStream << "\t";
#line 13 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
TILE_END	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t";
#line 15 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\t";
#line 16 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\t";
#line 17 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t";
#line 19 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
TILE_BEGIN("content")	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t\t<!-- Paginator -->\n";
	responseStream << "\t\t";
#line 22 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
...
#line 24 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (me.paginator.first());
	responseStream << "\">First</a>\n";
	responseStream << "\t\t\t\t<a class=\"paginatorChain\" href=\"*paginate?p=";
#line 25 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (me.paginator.prev());
	responseStream << "\">Prev</a>\n";
	responseStream << "\t\t\t\t";
#line 26 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
FOREACH(ind, me.paginator.indices)	responseStream << "\n";
	responseStream << "\t\t\t\t\t<a class=\"paginatorChain";
#line 27 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
...
#line 27 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	...
	responseStream << "</a>\n";
	responseStream << "\t\t\t\t";
#line 28 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
ENDFOR	responseStream << "\n";
	responseStream << "\t\t\t\t<a class=\"paginatorChain\" href=\"*paginate?p=";
#line 29 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (me.paginator.next());
	responseStream << "\">Next</a>\n";
	responseStream << "\t\t\t\t<a class=\"paginatorChain\" href=\"*paginate?p=";
#line 30 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (me.paginator.last());
	responseStream << "\">Last</a>\n";
	responseStream << "\t\t\t</div>\n";
	responseStream << "\t\t";
#line 32 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
COPY_END	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t\t<!-- User settings mode -->\n";
	responseStream << "\t\t";
#line 36 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
IF(me.mode() == me.MODE_SETTINGS)	responseStream << "\n";
	responseStream << "\t\t\t";
#line 37 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
IF(user)	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t\t\t\t";
#line 39 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
IF(user.group() == user.ADMIN)	responseStream << "\n";
	responseStream << "\t\t\t\t\t<a class=\"paginatorChain\" href=\"";
#line 40 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (page.path());
	responseStream << "?m=users\">&gt; Administer &lt;</a>\n";
	responseStream << "\t\t\t\t";
#line 41 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
ENDIF	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t\t\t\t<h1>Settings</h1>\n";
	responseStream << "\t\t\t\t<form method=\"POST\" action=\"*updateUser\">";
#line 44 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (CSRF);
	responseStream << "\n";
	responseStream << "\t\t\t\t\t<div class=\"userCol1\">FirstName:</div><div class=\"userCol2\"><input type=\"text\" ";
#line 45 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (NAME(firstName));
	responseStream << "></div>\n";
	responseStream << "\t\t\t\t\t<div class=\"userCol1\">LastName:</div><div class=\"userCol2\"><input type=\"text\" ";
#line 46 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (NAME(lastName));
	responseStream << "></div>\n";
	responseStream << "\t\t\t\t\t<div class=\"userCol1\">PhoneNumber:</div><div class=\"userCol2\"><input type=\"text\" ";
#line 47 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (NAME(phoneNumber));
	responseStream << "></div>\n";
	responseStream << "\n";
	responseStream << "\t\t\t\t\t<div class=\"userCol1\">Country:</div><div class=\"userCol2\"><select id=\"country\" ";
#line 49 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
...
#line 50 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (NAME(state));
	responseStream << "></select></div>\n";
	responseStream << "\t\t\t\t\t<script type=\"text/javascript\">populateCountries(\"country\", \"state\", \"";
#line 51 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
...
#line 53 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
...
#line 57 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (me["status"]);
	responseStream << "</span></div>\n";
	responseStream << "\t\t\t\t</form>\n";
	responseStream << "\t\t\t";
#line 59 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
ELSE	responseStream << "\n";
	responseStream << "\t\t\t\t<h1>Please register.</h1>\n";
	responseStream << "\t\t\t";
#line 61 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
ENDIF	responseStream << "\n";
	responseStream << "\t\t";
#line 62 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
ENDIF	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t\t<!-- User listing mode -->\n";
	responseStream << "\t\t";
#line 66 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
IF(me.mode() == me.MODE_USERS)	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t\t\t<a class=\"paginatorChain\" href=\"";
#line 68 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (page.path());
	...
	responseStream << "\t\t\t\t";
#line 72 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
PASTE("paginator")	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t\t\t\t<!-- Print table of Users -->\n";
	responseStream << "\t\t\t\t<div class=\"AdminUsersContainer\">\n";
	responseStream << "\t\t\t\t\t";
#line 76 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
TABLE(cell, me.userTable)	responseStream << "\n";
	responseStream << "\t\t\t\t\t\t";
#line 77 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
	responseStream << (cell);
	responseStream << "\n";
	responseStream << "\t\t\t\t\t";
#line 78 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
ENDTABLE	responseStream << "\n";
	...
	responseStream << "\t\t\t\t\t\t";
#line 88 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
OPTIONS(me.userGroups)	responseStream << "\n";
	...
	responseStream << "\t\t\t\t<!-- Draw paginator -->\n";
	responseStream << "\t\t\t\t";
#line 93 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
PASTE("paginator")	responseStream << "\n";
	responseStream << "\t\t\t</p>\n";
	responseStream << "\t\t";
#line 95 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
ENDIF	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t";
#line 97 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
TILE_END	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t";
#line 99 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\t";
#line 100 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t";
#line 102 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/User.c"
