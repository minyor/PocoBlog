...
#include "core/Tag.h"
#line 3 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/Contact.c"
PAGE(Contact)

void ContactHandler::handleRequest(Poco::Net::HTTPServerRequest& request, Poco::Net::HTTPServerResponse& response)
{
	response.setChunkedTransferEncoding(true);
	response.setContentType("text/html");

#line 5 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/Contact.c"
SESSION	std::ostream& responseStream = response.send();
	...
	responseStream << "\n";
	responseStream << "\t";
#line 7 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/Contact.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\t";
#line 8 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/Contact.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\t";
#line 9 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/Contact.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\t";
#line 10 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/Contact.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t";
#line 12 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/Contact.c"
TILE_BEGIN("content")	responseStream << "\n";
	responseStream << "\t\t<h1>Contact</h1>\n";
	responseStream << "\t\t<p>\n";
	responseStream << "\t\t\tnot implemented yet.\n";
	responseStream << "\t\t</p>\n";
	responseStream << "\t";
#line 17 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/Contact.c"
TILE_END	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t";
#line 19 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/Contact.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\t";
#line 20 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/Contact.c"
...
TILE_END	responseStream << "\n";
	responseStream << "\n";
	responseStream << "\t";
#line 22 "/media/DATA_1/_/Data/Core/Developing/WebServer/PocoBlog/src/view/Contact.c"
